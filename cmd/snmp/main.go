...
import (
	...
	"github.com/Rightech/ric-edge/internal/app/snmp/config"
	"github.com/Rightech/ric-edge/internal/app/snmp/entrypoint"
...
func main() {
	...
	res := update.Check(version, "snmp-"+runtime.GOOS+"-"+runtime.GOARCH)
	if res != "" {
