...
import (
	...
	"github.com/Rightech/ric-edge/internal/app/ble/config"
	"github.com/Rightech/ric-edge/internal/app/ble/entrypoint"
...
func main() {
	...
	res := update.Check(version, "ble-"+runtime.GOOS+"-"+runtime.GOARCH)
	if res != "" {
